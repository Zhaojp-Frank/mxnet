...
namespace mxnet {
namespace op {
inline bool SwapInitInferShape(const nnvm::NodeAttrs& attrs,
...
inline bool SwapInitInferType(const nnvm::NodeAttrs& attrs,
...
void SwapInitCompute(const nnvm::NodeAttrs& attrs,
                     const OpContext& ctx,
...
NNVM_REGISTER_OP(SwapInit)
  .set_num_inputs(0)
  .set_num_outputs(1)
  .set_attr<FCompute>("FCompute<cpu>", SwapInitCompute)
  .set_attr<nnvm::FInferShape>("FInferShape", SwapInitInferShape)
  .set_attr<nnvm::FInferType>("FInferType", SwapInitInferType)
