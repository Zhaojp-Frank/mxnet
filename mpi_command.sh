...
mpirun -outfile-pattern log_stdout_mlp_without_comm -errfile-pattern log_stderr_mlp_without_comm -l -np $NP -ppn 1  -hostfile host -print-rank-map -genv MXNET_P2PNET_MPI_SLEEP_DURATION=30000 -genv MXNET_P2PNET_DEBUG=2 -genv MXNET_P2PNET_HOST_PATH=/home/tofu/mxnet/host -genv MXNET_P2PNET_MAIN_AFFINITY=1 -genv MXNET_P2PNET_ZMQ_IO_THREADS=0 -genv KMP_AFFINITY="explicit,granularity=fine,proclist=[$AFFINITY]" python tofu_test_mlp.py -f host --batch_size=8192 --hidden_size=8192 --num_layers=5

# 5 layers MLP with communication
mpirun -outfile-pattern log_stdout_mlp_with_comm -errfile-pattern log_stderr_mlp_with_comm -l -np $NP -ppn 1  -hostfile host -print-rank-map -genv MXNET_P2PNET_MPI_SLEEP_DURATION=1 -genv MXNET_P2PNET_DEBUG=0 -genv MXNET_P2PNET_HOST_PATH=/home/tofu/mxnet/host -genv MXNET_P2PNET_MAIN_AFFINITY=1 -genv MXNET_P2PNET_ZMQ_IO_THREADS=0 -genv KMP_AFFINITY="explicit,granularity=fine,proclist=[$AFFINITY]" python tofu_test_mlp.py -f host --batch_size=8192 --hidden_size=8192 --num_layers=5

export TOFU_TILING_TYPE=datapar
# 5 layers MLP without communication
mpirun -outfile-pattern log_stdout_mlp_without_comm_dp -errfile-pattern log_stderr_mlp_without_comm -l -np $NP -ppn 1  -hostfile host -print-rank-map -genv MXNET_P2PNET_MPI_SLEEP_DURATION=30000 -genv MXNET_P2PNET_DEBUG=2 -genv MXNET_P2PNET_HOST_PATH=/home/tofu/mxnet/host -genv MXNET_P2PNET_MAIN_AFFINITY=1 -genv MXNET_P2PNET_ZMQ_IO_THREADS=0 -genv KMP_AFFINITY="explicit,granularity=fine,proclist=[$AFFINITY]" python tofu_test_mlp.py -f host --batch_size=8192 --hidden_size=8192 --num_layers=5

# 5 layers MLP with communication
mpirun -outfile-pattern log_stdout_mlp_with_comm_dp -errfile-pattern log_stderr_mlp_with_comm -l -np $NP -ppn 1  -hostfile host -print-rank-map -genv MXNET_P2PNET_MPI_SLEEP_DURATION=1 -genv MXNET_P2PNET_DEBUG=0 -genv MXNET_P2PNET_HOST_PATH=/home/tofu/mxnet/host -genv MXNET_P2PNET_MAIN_AFFINITY=1 -genv MXNET_P2PNET_ZMQ_IO_THREADS=0 -genv KMP_AFFINITY="explicit,granularity=fine,proclist=[$AFFINITY]" python tofu_test_mlp.py -f host --batch_size=8192 --hidden_size=8192 --num_layers=5

# 5 layers Conv single machine
mpirun -outfile-pattern log_stdout_conv_single -l -np $NP -ppn 1  -hostfile host -print-rank-map -genv MXNET_P2PNET_MPI_SLEEP_DURATION=1 -genv MXNET_P2PNET_DEBUG=0 -genv MXNET_P2PNET_HOST_PATH=/home/tofu/mxnet/host -genv MXNET_P2PNET_MAIN_AFFINITY=1 -genv MXNET_P2PNET_ZMQ_IO_THREADS=0 -genv KMP_AFFINITY="explicit,granularity=fine,proclist=[$AFFINITY]" python tofu_test_conv.py --batch_size=256 --channel_size=512 --filter_size=512 --num_layers=5 --addresses=127.0.0.1 -i 0

export TOFU_TILING_TYPE=kcuts
# 5 layers Conv without communication
mpirun -outfile-pattern log_stdout_conv_without_comm -errfile-pattern log_stderr_conv_without_comm -l -np $NP -ppn 1  -hostfile host -print-rank-map -genv MXNET_P2PNET_MPI_SLEEP_DURATION=30000 -genv MXNET_P2PNET_DEBUG=2 -genv MXNET_P2PNET_HOST_PATH=/home/tofu/mxnet/host -genv MXNET_P2PNET_MAIN_AFFINITY=1 -genv MXNET_P2PNET_ZMQ_IO_THREADS=0 -genv KMP_AFFINITY="explicit,granularity=fine,proclist=[$AFFINITY]" python tofu_test_conv.py -t host --batch_size=256 --channel_size=512 --filter_size=512 --num_layers=5

# 5 layers Conv with communication
mpirun -outfile-pattern log_stdout_conv_with_comm -errfile-pattern log_stderr_conv_with_comm -l -np $NP -ppn 1  -hostfile host -print-rank-map -genv MXNET_P2PNET_MPI_SLEEP_DURATION=1 -genv MXNET_P2PNET_DEBUG=0 -genv MXNET_P2PNET_HOST_PATH=/home/tofu/mxnet/host -genv MXNET_P2PNET_MAIN_AFFINITY=1 -genv MXNET_P2PNET_ZMQ_IO_THREADS=0 -genv KMP_AFFINITY="explicit,granularity=fine,proclist=[$AFFINITY]" python tofu_test_conv.py -t host --batch_size=256 --channel_size=512 --filter_size=512 --num_layers=5

export TOFU_TILING_TYPE=datapar
# 5 layers Conv without communication
mpirun -outfile-pattern log_stdout_conv_without_comm_dp -errfile-pattern log_stderr_conv_without_comm -l -np $NP -ppn 1  -hostfile host -print-rank-map -genv MXNET_P2PNET_MPI_SLEEP_DURATION=30000 -genv MXNET_P2PNET_DEBUG=2 -genv MXNET_P2PNET_HOST_PATH=/home/tofu/mxnet/host -genv MXNET_P2PNET_MAIN_AFFINITY=1 -genv MXNET_P2PNET_ZMQ_IO_THREADS=0 -genv KMP_AFFINITY="explicit,granularity=fine,proclist=[$AFFINITY]" python tofu_test_conv.py -t host --batch_size=256 --channel_size=512 --filter_size=512 --num_layers=5

# 5 layers Conv with communication
mpirun -outfile-pattern log_stdout_conv_with_comm_dp -errfile-pattern log_stderr_conv_with_comm -l -np $NP -ppn 1  -hostfile host -print-rank-map -genv MXNET_P2PNET_MPI_SLEEP_DURATION=1 -genv MXNET_P2PNET_DEBUG=0 -genv MXNET_P2PNET_HOST_PATH=/home/tofu/mxnet/host -genv MXNET_P2PNET_MAIN_AFFINITY=1 -genv MXNET_P2PNET_ZMQ_IO_THREADS=0 -genv KMP_AFFINITY="explicit,granularity=fine,proclist=[$AFFINITY]" python tofu_test_conv.py -t host --batch_size=256 --channel_size=512 --filter_size=512 --num_layers=5
