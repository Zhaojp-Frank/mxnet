...
#mpirun -outfile-pattern log_stdout_mm_single -l -np $NP -ppn 1 -rdma -hostfile host -print-rank-map -genv MXNET_P2PNET_MPI_SLEEP_DURATION=30000 -genv MXNET_P2PNET_DEBUG=0 -genv MXNET_P2PNET_HOST_PATH=/home/fegin/workspace/mxnet/host -genv MXNET_P2PNET_MAIN_AFFINITY=1 -genv MXNET_P2PNET_ZMQ_IO_THREADS=0 -genv KMP_AFFINITY="explicit,granularity=fine,proclist=[$AFFINITY]" python /home/fegin/workspace/mxnet/tests/python/unittest/test_p2pnet_mlp.py -b 8192 -w 8192 -l 5 -n 50 -g 5 -s

# 5 layers matrix multiplication without communication
#mpirun -outfile-pattern log_stdout_mm_without_comm -l -np $NP -ppn 1 -rdma -hostfile host -print-rank-map -genv MXNET_P2PNET_MPI_SLEEP_DURATION=30000 -genv MXNET_P2PNET_DEBUG=2 -genv MXNET_P2PNET_HOST_PATH=/home/fegin/workspace/mxnet/host -genv MXNET_P2PNET_MAIN_AFFINITY=1 -genv MXNET_P2PNET_ZMQ_IO_THREADS=0 -genv KMP_AFFINITY="explicit,granularity=fine,proclist=[$AFFINITY]" python /home/fegin/workspace/mxnet/tests/python/unittest/test_p2pnet_mlp.py -f host -b 8192 -w 8192 -l 5 -n 50 -g 5
