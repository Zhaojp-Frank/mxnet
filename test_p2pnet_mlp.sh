...
addresses=216.165.108.108:9000,216.165.108.109:9000
...
python tests/python/unittest/test_p2pnet_mlp.py --address=$addresses -b $batch -w $weight -l $layers -n $iterations -g $ignored -i $1 -e m2_l1_comm_$1_ | tee m2_l1_comm_$1
