...
python tests/python/unittest/test_p2pnet_mlp.py -f all_ips -b $batch -w $weight -l $layers -n $iterations -g $ignored -i $1 -e l${layers}_comm_$1 | tee l${layers}_comm_$1
export MXNET_P2PNET_DEBUG=3
python tests/python/unittest/test_p2pnet_mlp.py -f all_ips -b $batch -w $weight -l $layers -n $iterations -g $ignored -i $1 -e l${layers}_no_comm_$1 | tee l${layers}_no_comm_$1
export MXNET_P2PNET_DEBUG=1
