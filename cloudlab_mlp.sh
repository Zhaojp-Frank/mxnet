...
OPTIONS=$OPTIONS" -x NNVM_EXEC_MATCH_RANGE=1 "
...
#mpirun $OPTIONS -output-filename log_mlp_with_comm_${NP}_${B}_${H} -x MXNET_P2PNET_DEBUG=0 -x TOFU_TILING_TYPE=datapar $CMD -f $HOST
