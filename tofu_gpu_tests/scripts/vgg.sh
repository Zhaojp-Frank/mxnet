...
do
  ...
  do
    ...
    python ../tofu_benchmark.py vgg \
      ...
      2>&1 | tee vgg_b${b}_tofu_${n}.log | grep average
  done
done
...
do
  ...
  do
    ...
    python ../tofu_benchmark.py vgg \
      --batch_size=$b --num_gpus=$n \
      2>&1 | tee vgg_b${b}_dp_${n}.log | grep average
  done
done
...
do
  ...
  do
    ...
    python ../tofu_benchmark.py vgg \
      --batch_size=$b --num_gpus=$n \
      2>&1 | tee vgg-no-comm_b${b}_tofu_${n}.log | grep average
  done
done
...
do
  ...
  do
    ...
    python ../tofu_benchmark.py vgg \
      --batch_size=$b --num_gpus=$n \
      2>&1 | tee vgg-no-comm_b${b}_dp_${n}.log | grep average
  done
done
